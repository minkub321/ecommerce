...
<section id="best-sellers" class="bg-light py-5 bg-gray-100">
    <div class="container mx-auto px-4">
        ...
        <div class="row mt-6">
            <?php if($bestSellingProducts->count() > 0): ?>
                <div class="swiper main-swiper py-4" data-aos="fade-up" data-aos-delay="600">
                    <div class="swiper-wrapper d-flex border-animation-left">
                        <?php $__currentLoopData = $bestSellingProducts->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="banner-item image-zoom-effect bg-white rounded-2xl shadow-lg hover:shadow-xl transition duration-300 overflow-hidden">
                                    ...
                                    <div class="banner-content py-4 text-center px-4">
                                        <h5 class="element-title text-uppercase text-lg font-semibold text-gray-700 mb-2">
                                            <?php echo e(($index + 1) . '. ' . $product->product_name); ?>

                                        </h5>
                                        <p class="text-gray-700 font-medium">฿<?php echo e($product->price); ?></p>
                                        <div class="btn-left mt-3">
                                        <a href="<?php echo e(route('singleproduct', [$product->id, $product->slug])); ?>" class="btn btn-warning w-100 fw-semibold shadow-sm hover:shadow-md transition-all">ดูรายระเอียดสิ้</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php $__currentLoopData = $groupedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryName => $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<section class="product-carousel py-5 position-relative overflow-hidden" id="category-<?php echo e(Str::slug($categoryName)); ?>">
  <div class="container">
    <div class="d-flex flex-wrap justify-content-between align-items-center mt-5 mb-3">
      <h4 class="text-uppercase"><?php echo e($categoryName); ?></h4>
      <a href="<?php echo e(route('producting')); ?>" class="text-yellow-500 hover:underline font-medium">ดูสินค้าทั้งหมด</a>
    </div>
          ...
          <div class="product-item image-zoom-effect link-effect">
            <div class="image-holder">
              ...
              <div class="product-content mt-3">
                ...
                <p class="mb-1">💰 ราคา <?php echo e($product->price); ?> บาท</p>
                <p class="mb-2">📦 คงเหลือ <?php echo e($product->quantity); ?> ชิ้น</p>
...
<?php echo $__env->make('user_template.layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\www\ecommerce\resources\views/user_template/home.blade.php ENDPATH**/ ?>