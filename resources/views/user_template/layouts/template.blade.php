...
<body class="homepage">
      ...
      <div class="order-md-last">
        ...
        <ul class="list-group mb-3">
          ...
          <li class="list-group-item flex items-center gap-4">
            ...
            <div class="flex-1">
              <h6 class="text-gray-900 font-medium">{{ $product->product_name }}</h6>
              <small class="text-gray-500">Quantity: {{ $item->quantity }}</small>
            </div>

            <div class="text-lg font-semibold text-green-600">${{ number_format($item->price, 2) }}</div>

            <!-- Remove Button -->
            <a href="{{ route('removeitem', $item->id) }}" class="text-red-500 hover:text-red-700 transition-all">
              ❌
            </a>
          </li>
          @endforeach
        ...
        <a href="{{ route('shippingaddress') }}"
          class="w-full btn btn-primary btn-lg mt-4 {{ $total == 0 ? 'opacity-50 cursor-not-allowed' : '' }}" {{
          $total==0 ? 'disabled' : '' }}>
          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end flex-grow-1 gap-1 gap-md-5 pe-3">
                ...
                <!-- 
                <li class="nav-item ">
                  <a class="nav-link  active" href="{{route('newrelease')}}" aria-haspopup="true" aria-expanded="false">New Releases</a>                  
                </li>

                <li class="nav-item ">
                  <a class="nav-link  active" href="{{route('todaysdeal')}}"   aria-haspopup="true" aria-expanded="false">Today's Deals</a>                 
                </li>

                <li class="nav-item ">
                  <a class="nav-link  active" href="{{route('customersevice')}}"  aria-haspopup="true" aria-expanded="false">Customer Service</a>
          ...
          <ul class="list-unstyled d-flex m-0">
            ...
            <li class="nav-item relative" x-data="{ open: false }">
              ...
              <div x-show="open" @click.away="open = false"
                ...
                <a href="{{ route('admindashboard') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                แผงผู้ดูแลระบบ
                </a>
            ...
            <li class="d-none d-lg-block">
              <a href="" class="text-uppercase mx-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart"
                ...
                ตะกล้าสินค้า <span class="cart-count">({{ $cart_items->count() ?? 0 }})</span>
              </a>
            </li>
        ...
        <div class="col-md-3 col-sm-6">
          <div class="footer-menu footer-menu-001">
            <div class="footer-intro mb-4">
              <a href="index.html">
                <img src="{{asset('home/images/main-logo.png') }}" alt="logo">
              </a>
            </div>
        ...
        <div class="row">
          <div class="col-md-6 d-flex flex-wrap">
            <div class="shipping">
              ...
              <img src="{{asset('home/images/arct-icon.png') }}" alt="icon">
              <img src="{{asset('home/images/dhl-logo.png') }}" alt="icon">
            </div>
            <div class="payment-option">
              <span>Payment Option:</span>
              <img src="{{asset('home/images/visa-card.png') }}" alt="card">
              <img src="{{asset('home/images/paypal-card.png') }}" alt="card">
              <img src="{{asset('home/images/master-card.png') }}" alt="card">
            </div>
          </div>
  ...
  <script src="{{asset('home/js/script.min.js') }}"></script>
</body>
