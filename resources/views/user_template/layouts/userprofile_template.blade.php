...
<section class="container mx-auto px-6 py-10">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="bg-white shadow-xl rounded-2xl p-6 border border-gray-200 w-full h-full">
            ...
            <ul class="space-y-3">
                <li>
                    <a href="{{route('profile.edit')}}" class="flex items-center text-gray-700 hover:text-yellow-500 transition">
                ...
                <li>
                    <a href="{{route('pendingorder')}}" class="flex items-center text-gray-700 hover:text-yellow-500 transition">
                        <svg class="w-5 h-5 mr-2 text-gray-400" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <li>
                    <a href="{{route('history')}}" class="flex items-center text-gray-700 hover:text-yellow-500 transition">
                        <svg class="w-5 h-5 mr-2 text-gray-400" fill="none" stroke="currentColor" stroke-width="2"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <li>
                    <form method="POST" action="{{ route('logout') }}" class="flex items-center text-gray-700 hover:text-red-500 transition">
                        @csrf
